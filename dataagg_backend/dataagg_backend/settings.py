"""
Django settings for dataagg_backend project.
...
SECRET_KEY = 'nt(s8=m+ou=i)&+d4k$m(^sk@wbbroy%#82=(+obg!r)@*sp99'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '52.66.178.90']
...
ROOT_URLCONF = 'dataagg_backend.urls'
...
WSGI_APPLICATION = 'dataagg_backend.wsgi.application'
